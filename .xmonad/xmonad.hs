...
--   (OO )_.->
--   (_| \_)--.
--   \  `.'  /     __   ____  ____   ____  __   __  ________
--    \    .')     | |  |  _| | _ | |    | | |  | \  \___  /
--    .'    \      | |  ||-_  |___| | || | | |  | _\    / /___
...
myFont :: String
myFont = "xft:CaskaydiaCove Nerd Font Mono Mono:regular:size=9:antialias=true:hinting=true"
...
myMusica :: String
myMusica = "nuclear"            -- Music App / Nuclear

myWallpaper :: String
myWallpaper = "nitrogen"        -- Wallpaper

myFileman :: String
myFileman = "pcmanfm"            -- File Manager
